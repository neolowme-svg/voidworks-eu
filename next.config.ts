...
const nextConfig:NextConfig={
  ...
  async headers(){return [
    ...
    { source:"/forgot-password", headers:[{key:"Cache-Control",value:"private, no-store, max-age=0"}] },
    { source:"/account/:path*", headers:[{key:"Cache-Control",value:"private, no-store, max-age=0"}] },
    { source:"/project-request/:path*", headers:[{key:"Cache-Control",value:"private, no-store, max-age=0"}] },
