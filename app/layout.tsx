...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="nl" data-theme="dark"><body><PreferencesProvider><SiteHeader /><div className="route-stage">{children}</div><SiteFooter /><MotionInit /></PreferencesProvider></body></html>;
}
