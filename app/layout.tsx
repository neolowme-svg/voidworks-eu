...
export default function RootLayout({children}:{children:React.ReactNode}){
  return <html lang="nl" data-theme="dark"><body><PreferencesProvider><SkipLink/><SiteHeader/><div className="route-stage" id="main-content" tabIndex={-1}>{children}</div><SiteFooter/><CookieConsent/><MotionInit/></PreferencesProvider></body></html>;
}
