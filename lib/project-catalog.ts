...
export const addons: AddonDefinition[] = [
  ...
  { id:"language", prices:{landing:30,website:45,shop:60,platform:70}, names:{nl:"Extra taal",en:"Extra language",de:"Zusätzliche Sprache"}, descriptions:{nl:"Voeg één extra vertaalde taalversie toe.",en:"Add one additional translated language version.",de:"Eine weitere übersetzte Sprachversion ergänzen."} },
