...
export function PricingConfigurator() {
  ...
  const addons: Addon[] = locale === "en" ? [
    ...
    { id:"vip", name:"VIP support", description:"Priority support for questions and small changes.", monthly:true, prices:{ landing:10, website:10, shop:15, platform:20 } },
    { id:"admin", name:"Admin panel", description:"Secure management area for content or data.", prices:{ landing:50, website:50, shop:50 }, included:["platform"] },
    { id:"cms", name:"CMS", description:"Edit pages, sections or structured content yourself.", prices:{ landing:75, website:75, shop:75, platform:60 } },
    ...
    { id:"api", name:"Extra API integration", description:"Connect an external service or data source.", prices:{ website:60, shop:50, platform:35 } },
    { id:"seo", name:"SEO launch pack", description:"Extended metadata, sitemap, redirects and launch review.", prices:{ website:45, shop:55, platform:60 } },
    { id:"language", name:"Extra language", description:"Add one additional translated language version.", prices:{ landing:30, website:45, shop:55, platform:65 } },
    { id:"copy", name:"Copywriting help", description:"Improve structure, headlines and key conversion copy.", prices:{ landing:35, website:55, shop:65, platform:75 } },
  ] : locale === "de" ? [
    ...
    { id:"vip", name:"VIP-Support", description:"Priorisierter Support für Fragen und kleine Änderungen.", monthly:true, prices:{ landing:10, website:10, shop:15, platform:20 } },
    { id:"admin", name:"Admin-Panel", description:"Geschützter Verwaltungsbereich für Inhalte oder Daten.", prices:{ landing:50, website:50, shop:50 }, included:["platform"] },
    { id:"cms", name:"CMS", description:"Seiten, Bereiche oder strukturierte Inhalte selbst verwalten.", prices:{ landing:75, website:75, shop:75, platform:60 } },
    ...
    { id:"api", name:"Zusätzliche API", description:"Externe Dienste oder Datenquellen anbinden.", prices:{ website:60, shop:50, platform:35 } },
    { id:"seo", name:"SEO Launch Pack", description:"Erweiterte Metadaten, Sitemap, Redirects und Launch-Check.", prices:{ website:45, shop:55, platform:60 } },
    { id:"language", name:"Zusätzliche Sprache", description:"Eine weitere übersetzte Sprachversion ergänzen.", prices:{ landing:30, website:45, shop:55, platform:65 } },
    { id:"copy", name:"Copywriting-Hilfe", description:"Struktur, Headlines und Conversion-Texte verbessern.", prices:{ landing:35, website:55, shop:65, platform:75 } },
  ] : [
    ...
    { id:"vip", name:"VIP support", description:"Voorrang bij supportvragen en kleine wijzigingen.", monthly:true, prices:{ landing:10, website:10, shop:15, platform:20 } },
    { id:"admin", name:"Admin panel", description:"Beveiligde beheeromgeving voor content of data.", prices:{ landing:50, website:50, shop:50 }, included:["platform"] },
    { id:"cms", name:"CMS", description:"Zelf pagina's, secties of gestructureerde content beheren.", prices:{ landing:75, website:75, shop:75, platform:60 } },
    ...
    { id:"api", name:"Extra API-koppeling", description:"Koppel een externe dienst of databron aan je project.", prices:{ website:60, shop:50, platform:35 } },
    { id:"seo", name:"SEO launch pack", description:"Uitgebreide metadata, sitemap, redirects en launch-check.", prices:{ website:45, shop:55, platform:60 } },
    { id:"language", name:"Extra taal", description:"Voeg één extra vertaalde taalversie toe.", prices:{ landing:30, website:45, shop:55, platform:65 } },
    { id:"copy", name:"Copywriting hulp", description:"Structuur, headings en belangrijke conversieteksten verbeteren.", prices:{ landing:35, website:55, shop:65, platform:75 } },
  ];
